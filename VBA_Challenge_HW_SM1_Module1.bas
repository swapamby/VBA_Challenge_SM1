...
For Each CurrentWs In Worksheets
        ...
        'define location for each ticker name in the summary table'
        ...
        'Additional Titles for new Summary Table on the right'
        ...
        ' holding the ticker name'
        
        Dim Ticker_Name As String
        Ticker_Name = " "
        
        ' holding the total volume per ticker name'
        ...
        'initial value for open price of first ticker'
        
        Open_Price = CurrentWs.Cells(2, 3).Value
         
        
        'looping values for next tickers'
